    ...
    <Dialog open={modal} onOpenChange={setModal}>
      ...
      >
        <div className="w-full whitespace-nowrap">
          <p className="font-roboto text-xs font-medium">SALIDA EFECTIVO</p>
        </div>
      </DialogTrigger>
      <DialogContent className="max-h-[80vh] overflow-auto px-0 pt-0 pb-2 sm:max-w-[462px]">
        ...
        <Form
          ...
          method="post"
        >
          <h2 className="text-roboto text-lg font-extrabold text-[#D7586B]">
            SALIDA DE EFECTIVO
          </h2>
          ...
          <DialogFooter>
            <Button
              form="own-bank-form"
              className="h-[31px] w-full max-w-[110px] rounded-3xl bg-primarioBotones text-center font-roboto text-xs font-semibold"
