...
function ModalDestroyMetaKeys({ modal, setModal }) {
    ...
    <Dialog open={modal} onOpenChange={setModal}>
      <DialogContent className="overflow-auto border-none bg-black p-0 sm:max-w-[425px]">
        ...
        <Form
          ...
          method="post"
        >
          <input type="hidden" value={8} name="type_function" />
          <span className="font-roboto text-[#A6A6A6]">
            Está intentando desvincular tu cuenta de meta, ¿está seguro?
          </span>
...
export default ModalDestroyMetaKeys;
