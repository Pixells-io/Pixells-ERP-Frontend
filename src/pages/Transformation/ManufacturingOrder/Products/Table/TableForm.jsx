        ...
        cell: ({ row, rowIndex }) => (
          <div className="w-[100px]">
            <Select
              ...
              value={row.component}
            >
              <SelectTrigger className="w-[220px] rounded-lg border border-gris2-transparent text-xs font-light text-grisSubText placeholder:text-grisHeading focus:ring-2 focus:ring-primarioBotones focus:border-transparent">
