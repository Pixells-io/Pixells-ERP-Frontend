...
const OrderEditor = () => {
  ...
  const url = "/sales/quotes/document/" + ordersSale?.data?.id;
  const [isShipping, setIsShipping] = useState(
    !(ordersSale?.data?.shipping == "0.00"),
  );
       ...
       <NavigationHeader/>
        ...
        <div className="flex items-center justify-between">
          <p className="mb-6 font-poppins text-[20px] font-bold text-[#44444F]">
            Consultando Orden: {ordersSale?.data?.id}
          </p>
        ...
        <div className="flex flex-col space-y-4 overflow-auto rounded-xl bg-white p-4 pr-12">
          <div className="overflow-auto">
            <div className="rounded-xl border border-blancoBox p-4">
              <SelectsQuoteShow data={ordersSale?.data} />
            </div>
            ...
            <div>
              <div className="mt-6">
                <QuoteTableShow tableData={ordersSale?.data?.slots} />
              </div>
              <TotalShow data={ordersSale?.data} />
            </div>
          </div>
