...
function ObjectiveAll() {
  ...
  const [dateStartInput, setDateStartInput] = useState(null);
  const [dateEndInput, setDateEndInput] = useState(null);
    ...
    <div className="flex flex-col">
      ...
      {addNewStage && (
        <Form className="flex h-12 items-center pl-7">
          <Input
            className="border-none bg-inherit text-xs font-normal text-grisDisabled placeholder:text-xs placeholder:font-normal placeholder:text-grisDisabled"
            ...
            <AccordionContent>
              ...
              {indexSubStage == indexOption && (
                <Form className="grid h-12 w-full grid-cols-12 items-center border-b">
                  ...
                  >
                    <Input
                      className="border-none bg-inherit text-xs font-normal text-[#CCCCCC] placeholder:text-xs placeholder:font-normal placeholder:text-[#CCCCCC]"
                    ...
                    <Popover open={openStart} onOpenChange={setOpenStart}>
                      <PopoverTrigger asChild>
                        <Button
                          variant={"outline"}
                          className={cn(
                            "h-[23px] w-fit min-w-fit justify-between rounded-[8px] border-none bg-gris px-0.5 font-roboto text-xs font-normal text-[#CCCCCC] focus-visible:ring-primarioBotones",
                  ...
                  <div className={"col-span-1 text-center text-xs font-normal"}>
                    {dateStartInput != "" && dateEndInput != "" ? (
                      <span className="text-[#CCCCCC]">
                        {calculateDays(dateStartInput, dateEndInput).toFixed(0)}
                        &nbsp;
