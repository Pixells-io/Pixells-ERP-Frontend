...
function DestroyProcessForm({ modal, setModal, id, idProcess }) {
    ...
    <Dialog open={modal} onOpenChange={setModal}>
      <DialogContent className="overflow-auto border-none bg-black p-0 sm:max-w-[425px]">
        ...
        <Form
          ...
          method="post"
        >
          <input type="hidden" value={idProcess} name="process_id" />
          <input type="hidden" value={2} name="type_of_function" />
          <span className="font-roboto text-[#A6A6A6]">
            You are trying to delete a process, are you sure?
          </span>
...
export default DestroyProcessForm;
