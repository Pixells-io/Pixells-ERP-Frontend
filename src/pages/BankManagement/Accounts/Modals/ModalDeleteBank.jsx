...
function ModalDeleteBank({ bank_id, bank_name }) {
  ...
  return (
    <Dialog open={modal} onOpenChange={setModal}>
      ...
      <DialogContent className="overflow-auto border-none bg-black p-0 px-8 sm:max-w-[425px]">
        ...
        >
          <input type="hidden" hidden name="bank_id" value={bank_id} readOnly />
          <input
            type="hidden"
            hidden
            name="type_option"
          ...
          <span className="font-roboto text-[#A6A6A6]">
            You are trying to delete the bank {bank_name}, are you sure?
          </span>
