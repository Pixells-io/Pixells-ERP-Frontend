            ...
            <TableRow key={rowIndex}>
              {Object.values(row).map((cell, cellIndex) => (
                <TableCell key={cellIndex} className="text-center font-roboto text-xs">
                  {cellIndex === 3 ? ( // Si estamos en la columna "Estatus"
                    <div className="bg-[#F4F3C9] rounded-[20px] p-2 w-fit mx-auto font-roboto font-semibold text-[#625E0E]">
                      {cell}
                    </div>
                  ) : (
                    cell
...
export default ClientPipelineTable;
