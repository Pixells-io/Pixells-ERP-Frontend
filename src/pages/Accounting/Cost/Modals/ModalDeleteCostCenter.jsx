      ...
      <DialogContent className="flex max-w-[400px] flex-col gap-4 border-0 bg-[#242424]">
        ...
        >
          ...
          <input
            ...
            hidden
            name="type_option"
            value={"destroy_costCenter"}
            readOnly
          />
          <span className="my-4 font-roboto text-xs font-light text-grisDisabled">
            You are trying to delete the cost center "{costCenter_name}", are you sure?
          </span>
          <DialogFooter>
...
export default ModalDeleteCostCenter;
