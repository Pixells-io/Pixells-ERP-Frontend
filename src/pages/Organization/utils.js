...
export async function editArea(data) {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_SERVER_URL}organization/edit-area`,
    {
      method: "POST",
      body: JSON.stringify(area),
      headers: {
...
export async function editPosition(data) {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_SERVER_URL}organization/edit-puesto`,
    {
      method: "POST",
      body: JSON.stringify(position),
      headers: {
...
export async function savePermission(position, permision, module) {
  ...
  const response = await fetch(
    `${import.meta.env.VITE_SERVER_URL}organization/permission-update`,
    {
      method: "POST",
      body: JSON.stringify(info),
      headers: {
