                            ...
                            <TabsList className="bg-transparent w-full mb-3">
                                <div className="flex w-full">
                                    {areas.data?.map((area, i) => (
                                        <TabsTrigger className="rounded-none text-sm font-normal data-[state=active]:text-primarioBotones data-[state=active]:font-medium data-[state=active]:border-b-2 data-[state=active]:border-blue-500 font-roboto  text-grisSubText border-b-2 border-slate-300 p-3" value={area.id}> {area.nombre} </TabsTrigger>
                                    ))}
                                </div>
                            </TabsList>
                            {areas.data?.map((area, i) => (
