        ...
        <div className="flex-shrink-0 ml-6">
          <div className="flex flex-col space-y-4">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="inventario" className="ml-2 text-[14px] font-roboto text-gris2">Inventario</label>
            </div>
            <div className="flex items-center">
              <Checkbox
                id="compra"
                ...
                className="border-primarioBotones data-[state=checked]:bg-primarioBotones data-[state=checked]:text-white"
              />
              <label htmlFor="compra" className="ml-2 text-[14px] font-roboto text-gris2">Compra</label>
            </div>
            <div className="flex items-center">
              <Checkbox
                id="venta"
                ...
                className="border-primarioBotones data-[state=checked]:bg-primarioBotones data-[state=checked]:text-white"
              />
              <label htmlFor="venta" className="ml-2 text-[14px] font-roboto text-gris2">Venta</label>
            </div>
          </div>
        </div>
      </div>
