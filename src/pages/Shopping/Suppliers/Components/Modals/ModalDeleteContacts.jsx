...
import { person, storefront, trashOutline } from "ionicons/icons";

function ModalDeleteContact({ client_id, contact_id, contact_name }) {
      ...
      <DialogContent className="flex max-w-[400px] flex-col gap-4 border-0 bg-[#242424]">
        ...
        >
          ...
          <input
            ...
            hidden
            name="type"
            value={"destroy_contact"}
            readOnly
          />
          <span className="my-4 font-roboto text-xs font-light text-grisDisabled">
            You are trying to delete the contact "{contact_name}", are you sure?
          </span>
          <DialogFooter>
