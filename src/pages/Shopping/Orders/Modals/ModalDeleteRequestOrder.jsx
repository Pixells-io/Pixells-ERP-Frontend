...
function ModalDeleteRequestOrder({
  id,
  name,
  modal,
  setModal,
  ...
  return (
    <Dialog open={modal} onOpenChange={setModal}>
      <DialogContent className="flex max-w-[400px] flex-col gap-4 border-0 bg-[#242424]">
        ...
        <Form
          action={`/shopping/request-orders`}
          method="post"
        ...
        >
          ...
          <span className="my-4 font-roboto text-xs font-light text-grisDisabled">
            You are trying to delete the request order "{name}", are you sure?
          </span>
          <DialogFooter>
...
export default ModalDeleteRequestOrder;
