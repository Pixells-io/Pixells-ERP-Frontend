    ...
    <div className="bg-[#FBFBFB] w-full mx-5 rounded-xl flex flex-col h-full justify-between">
      ...
      <div className="bg-gris px-6 rounded-t-xl py-4 flex">
        ...
        <div className="w-10/12 m-auto">
          <span className="font-poppins font-semibold text-lg text-grisHeading"> {chatPusher[0].name} </span>
        </div>
        <div className="w-1/12 m-auto*">
      ...
      <div className="bg-[#E0E0E0] rounded-b-xl px-5 py-2 flex w-full ">
        <div className="w-5/6 px-5">
          <input type="text" ref={inputMsg} onKeyPress={sendMensageEnter} className="w-full font-roboto font-light text-grisText px-4 py-2 rounded-xl ring-0" placeholder="Type your message..." />
        </div>
